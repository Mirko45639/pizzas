                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <form class="user" action="{{ route('producto.update',['producto'=>$producto->id])}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    ...
                                    <div class="form-group row">
                                    <label for="fotito" style="background-image: url('/assets/img/descarga.png'); width: 40px !important;height: 40px !important;  background-size: cover !important;">
                                        <input  id="fotito" style="opacity: 1; display:block" type="file" name="foto"  class=" "></label>&nbsp;&nbsp;&nbsp;&nbsp;Foto subir
                                    </div>
