...
@section('content')
<div class="container" ng-app="pedido" ng-controller="controlCrearPedido">
    <div class="row">
                            ...
                            <div class="p-5">
                                ...
                                <div class="container-fluid" ng-switch="vista">
                                    <div class="container" ng-switch-when="parte1">
                                        <form class="user" autocomplete="off" ng-submit="paso2()" method="post">
                                            @csrf
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <input type="text" ng-model="cliente.telefono" name="telefono" class="form-control form-control-user" placeholder="Celular">
                                                    </div>
                                                    <div class="form-group row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="row p-1" style="height: 370px; overflow-y:scroll;overflow-x:hidden;">
                                            ...
                                            <div class="col-md-8">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <input type="button" class="btn btn-block btn-primary" value="Crear Pedido" ng-click="CrearPedido()" >
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-2"></div>
